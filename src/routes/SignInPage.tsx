...
function signInLabels(locale: string): SignInLabels {
  if (locale.startsWith('es')) return {
    ...
    eyebrow: 'Acceso',
    heading: 'Bienvenido.',
    lead: '¿Primera vez? Creamos tu cuenta. ¿Ya nos conoces? Iniciamos sesión. Lo mismo correo, lo mismo enlace — sin contraseña, válido quince minutos.',
  ...
  if (locale.startsWith('pt')) return {
    ...
    eyebrow: 'Acesso',
    heading: 'Bem-vindo.',
    lead: 'Primeira vez? Criamos a tua conta. Já te conhecemos? Iniciamos sessão. O mesmo email, o mesmo link — sem palavra-passe, válido quinze minutos.',
    emailLabel: 'Email',
  ...
  if (locale.startsWith('de')) return {
    ...
    eyebrow: 'Anmeldung',
    heading: 'Willkommen.',
    lead: 'Erstes Mal? Wir legen dein Konto an. Schon dabei? Wir loggen dich ein. Gleiche E-Mail, gleicher Link — kein Passwort, fünfzehn Minuten gültig.',
    emailLabel: 'E-Mail',
  ...
  return {
    ...
    eyebrow: 'Sign in',
    heading: 'Welcome.',
    lead: 'First time? We create your account. Already with us? We sign you in. Same email, same link — no password, valid for fifteen minutes.',
    emailLabel: 'Email',
