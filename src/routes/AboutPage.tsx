...
/**
 * /about — the editorial-tone story of Voz Clara.
 *
 * Three sections:
 *   1. The origin story (why Voz Clara exists, who it's for)
 *   2. The "we" — Voz Clara under LEON MARÉ
...
function aboutLabels(locale: string) {
  if (locale.startsWith('es')) return {
    headTitle: 'Sobre Voz Clara',
    headDescription:
      'Voz Clara existe porque mi compañera, hispanohablante, quería acceder al conocimiento alemán en su idioma — sin tener que estudiar alemán durante años antes.',
    backHome: 'Volver a la página principal',
    aboutSection: 'Sobre nosotros',
    heroTitle: 'Una nube de conocimiento para personas que viven entre idiomas.',
    heroLead:
      'Voz Clara empezó como herramienta interna para una pareja bilingüe. La abrimos a todos los que aprenden, trabajan o crean a caballo entre lenguas.',
    ...
    originBody: [
      ...
      'Construí la primera versión de Voz Clara en una semana, como herramienta interna. La usaba dos personas. Ahora la abrimos para que cualquiera que viva entre lenguas tenga el mismo atajo.',
    ],

    parentSection: 'La marca matriz',
    parentHeading: 'Voz Clara vive bajo LEON MARÉ.',
    parentBody: [
      ...
      'Voz Clara es el primer producto digital bajo esa marca. Heredamos la estética y los principios — "FAZ statt Bild", forma sin ornamentación gratuita, contenido antes que efectismo. Y nos quedamos con la promesa: respetamos lo que se nos confía.',
    ...
    signatureBody:
      'Voz Clara existe porque alguien en tu vida — o tú mismo — querría acceder a lo que sólo se publica en una lengua que no domina. Si te resuena, prueba el Pack de ejemplo. Si te gusta, dile a alguien que viva entre idiomas.',
    ctaPrimary: 'Crear mi primer Pack',
    ctaSecondary: 'Ver un ejemplo',
  };

  if (locale.startsWith('pt')) return {
    headTitle: 'Sobre a Voz Clara',
    headDescription:
      'A Voz Clara existe porque a minha companheira, lusófona, queria aceder ao conhecimento alemão na sua língua — sem ter de estudar alemão durante anos primeiro.',
    backHome: 'Voltar à página principal',
    aboutSection: 'Sobre nós',
    heroTitle: 'Uma nuvem de conhecimento para pessoas que vivem entre idiomas.',
    heroLead:
      'A Voz Clara começou como ferramenta interna para um casal bilingue. Abrimo-la para todos os que aprendem, trabalham ou criam entre línguas.',
    ...
    originBody: [
      ...
      'Construí a primeira versão da Voz Clara numa semana, como ferramenta interna. Usavam-na duas pessoas. Agora abrimo-la para que quem viva entre línguas tenha o mesmo atalho.',
    ],

    parentSection: 'A marca-mãe',
    parentHeading: 'A Voz Clara vive sob a LEON MARÉ.',
    parentBody: [
      ...
      'A Voz Clara é o primeiro produto digital sob essa marca. Herdamos a estética e os princípios — "FAZ statt Bild", forma sem ornamentação gratuita, conteúdo antes de efeito. E ficamos com a promessa: respeitamos o que nos é confiado.',
    ...
    signatureBody:
      'A Voz Clara existe porque alguém na tua vida — ou tu próprio — gostaria de aceder ao que só se publica numa língua que não domina. Se ressoa, experimenta o Pack de exemplo. Se gostas, conta a alguém que viva entre línguas.',
    ctaPrimary: 'Criar o meu primeiro Pack',
    ctaSecondary: 'Ver um exemplo',
  };

  if (locale.startsWith('de')) return {
    headTitle: 'Über Voz Clara',
    headDescription:
      'Voz Clara existiert weil meine Partnerin, Spanisch-Muttersprachlerin, deutsches Wissen in ihrer Sprache verstehen wollte — ohne erst Jahre Deutsch zu lernen.',
    backHome: 'Zurück zur Startseite',
    aboutSection: 'Über uns',
    heroTitle: 'Eine Wissens-Cloud für Menschen die zwischen Sprachen leben.',
    heroLead:
      'Voz Clara begann als internes Werkzeug für ein zweisprachiges Paar. Wir öffnen es für alle die zwischen Sprachen lernen, arbeiten oder Inhalte produzieren.',
    ...
    originBody: [
      ...
      'Ich baute die erste Version von Voz Clara in einer Woche, als internes Werkzeug. Es nutzten es zwei Personen. Jetzt öffnen wir es damit jeder der zwischen Sprachen lebt dieselbe Abkürzung hat.',
    ],

    parentSection: 'Die Dachmarke',
    parentHeading: 'Voz Clara lebt unter LEON MARÉ.',
    parentBody: [
      ...
      'Voz Clara ist das erste digitale Produkt unter dieser Marke. Wir erben die Ästhetik und die Prinzipien — „FAZ statt Bild", Form ohne dekorative Spielerei, Inhalt vor Effekt. Und wir behalten das Versprechen: wir schützen, was uns anvertraut wird.',
    ...
    signatureBody:
      'Voz Clara existiert weil irgendjemand in deinem Leben — oder du selbst — auf das zugreifen wollen würde was nur in einer Sprache veröffentlicht wird die nicht beherrscht wird. Wenn es bei dir ankommt: probier den Beispiel-Pack. Wenn du es magst: erzähl es jemandem der zwischen Sprachen lebt.',
    ctaPrimary: 'Meinen ersten Pack erstellen',
    ctaSecondary: 'Ein Beispiel ansehen',
  };

  return {
    headTitle: 'About Voz Clara',
    headDescription:
      'Voz Clara exists because my partner, a native Spanish speaker, wanted access to German knowledge in her own language — without spending years learning German first.',
    backHome: 'Back to home',
    aboutSection: 'About us',
    heroTitle: 'A knowledge cloud for people who live between languages.',
    heroLead:
      'Voz Clara started as an internal tool for a bilingual couple. We are opening it to everyone who learns, works or creates across languages.',
    ...
    originBody: [
      ...
      'I built the first version of Voz Clara in a week, as an internal tool. Two people used it. We are opening it so anyone who lives between languages has the same shortcut.',
    ],

    parentSection: 'The parent brand',
    parentHeading: 'Voz Clara lives under LEON MARÉ.',
    parentBody: [
      ...
      'Voz Clara is the first digital product under that brand. We inherit the aesthetic and the principles — "FAZ statt Bild", form without decorative play, content over effect. And we keep the promise: we protect what is entrusted to us.',
    ...
    signatureBody:
      'Voz Clara exists because someone in your life — or you yourself — would want access to content only published in a language they do not speak. If that resonates, try the sample Pack. If you like it, tell someone who lives between languages.',
